<x-layout>
    ...
    <div class="swiper banner-swiper">
        <div class="swiper-wrapper">
            ...
            <div class="swiper-slide">
                <img src="{{ asset('images/banner/banner-3.jpg') }}" alt="Banner 3"
                    class="w-full h-[500px] object-cover">
            </div>
            <div class="swiper-slide">
                <img src="{{ asset('images/banner/banner-1.jpg') }}" alt="Banner 4"
                    class="w-full h-[500px] object-cover">
            </div>
            <div class="swiper-slide">
                <img src="{{ asset('images/banner/banner-2.jpg') }}" alt="Banner 5"
                    class="w-full h-[500px] object-cover">
            </div>
        </div>
